 ...
 * @author Kalhara
 */
public class NewLoanType extends javax.swing.JDialog {

    /**
     * Creates new form NewLoanType
     */
    public NewLoanType(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "New Loan Type", 0, 0, new java.awt.Font("Bodoni MT", 3, 30), new java.awt.Color(0, 102, 255))); // NOI18N
        ...
        nameText.setToolTipText("Loan type name");
        ...
        rateText.setToolTipText("Loan type rate");
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        try {
            ...
            loanType.setName(nameText.getText());
            loanType.setRate(Integer.parseInt(rateText.getText()));
            LoanTypeController.addNewLoanType(loanType);
            JOptionPane.showMessageDialog(null, "Loan Type Added Success");
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewLoanType.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NewLoanType dialog = new NewLoanType(new javax.swing.JFrame(), true);
